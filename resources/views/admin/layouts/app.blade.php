        ...
        <div class="sidebar">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item">
                        <a href="{{route('admin.catPages.index')}}" class="nav-link 
                        @php
                            if (Str::substr(Request::getRequestUri(), 0, 15) == '/admin/catPages') {
                                echo 'active';
                            }
                        @endphp">
                            <i class="nav-icon bi bi-clipboard-plus"></i>
                            <p>
                                Sahifalar kategoriyalari
                            </p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{route('admin.page.index')}}" class="nav-link @php
                            if (Str::substr(Request::getRequestUri(), 0, 11) == '/admin/page') {
                                echo 'active';
                            }
                        @endphp">
                    ...
                    <li class="nav-item">
                        <a href="{{route('admin.galleries.index')}}" class="nav-link @php
                            if (Str::substr(Request::getRequestUri(), 0, 16) == '/admin/galleries') {
                                echo 'active';
                            }
                        @endphp">
                    ...
                    <li class="nav-item
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="{{route('admin.siteImages.index')}}" class="nav-link @php
                                    if (Str::substr(Request::getRequestUri(), 0, 17) == '/admin/siteImages') {
                                        echo 'active';
                                    }
                                @endphp">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Rasm sozlamalari</p>
                                </a>
                            </li>
                            <li class="nav-item">

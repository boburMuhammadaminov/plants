                ...
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-10 mb-3">
                            <h3 class="card-title">Galareya</h3>
                        </div>
                        <div class="col-md-2">
                ...
                <div class="card-body p-0 table-responsive">
                    <table class="table table-sm">
                        ...
                        @foreach($galleries as $gallery)
                            <tr>
                                <td>{{ $loop->index+1 }}</td>
                                <td>{{ Str::limit($gallery->title_uz, 60) }}</td>
                                <td>{!! $gallery->getImage('width:150px') !!}</td>
                                <td>
                                    <div class="btn-group">
                                        <form action="{{route('admin.activation', ['id'=>$gallery->id])}}" method="POST">
                                ...
                                <td>
                                    <div class="btn-group">
                                        <a href="{{ route('admin.galleries.show', $gallery->id) }}" type="button"
                                           class="btn btn-primary btn-flat">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <a href="{{ route('admin.galleries.edit', $gallery->id) }}" type="button"

        ...
        <div class="col-md-12">
                ...
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-10 p-3">
                            <a href="{{route('admin.contact.index')}}" class="card-title cursor-pointer" style="cursor: pointer;">Yangi xabarlar ({{count($unread)}})</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-10 p-3">
                            <h3 class="card-title">Arxivdagi xabarlar</h3>
                        </div>
                    </div>
                </div>
                <!-- /.card-header -->
